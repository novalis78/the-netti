...
Imagine you inherited a library. Thousands of texts, in a language you're slowly learning, written by one of the most precise minds in human history. Some of them are simple and stunning --- a conversation by a river, a parable about a raft, a list of things to pay attention to when you sit down and close your eyes. Others are dense, technical, and seem to repeat the same formulas over and over until your eyes glaze.
...
And in the final part of the book, the manual delivers on its promise. The last chapter is an anthology --- a curated collection of the Buddha's own words, organized by the very categories the Netti has been teaching you. After nineteen chapters of learning \textit{how} to read, you get to \textit{read}: verses about the trap of craving, poems about the flash of awakening, passages that have been landing in human minds for twenty-five centuries. By the time you reach them, you'll read them differently than you would have at the start.
