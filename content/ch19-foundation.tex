\chapter{The Foundation of the Teaching}\index{sutta types (sixteen)|textbf}\index{Foundation of the Teaching|textbf}
\label{ch:foundation}
...
\noindent The very first verse of the Dhammapada\index{Dhammapada}. Everything begins with the mind. Corrupt the source, and everything downstream is poisoned.\footnote{Pali: \textit{``Manopubbaṅgamā dhammā, manoseṭṭhā manomayā; manasā ce paduṭṭhena, bhāsati vā karoti vā; tato naṃ dukkhamanveti, cakkaṃva vahato padanti.''} (Dhp 1).}
...
\noindent Past: gone. Future: not yet here. The present: the only place where practice is possible. And ``one fine night'' --- a single night of genuine presence is worth more than a lifetime of distraction.\footnote{Pali: \textit{``Atītaṃ nānvāgameyya, nappaṭikaṅkhe anāgataṃ \ldots Taṃ ve bhaddekarattoti, santo ācikkhate munīti.''} (MN 131 / SN). The Bhaddekaratta\index{Bhaddekaratta Sutta} Sutta --- ``One Fine Night'' or ``An Auspicious Night.'' A penetration-sharing sutta. The Buddha's teaching on presence is not abstract mindfulness advice but an urgent call: \textit{today} is the day.}
...
\section*{The Radiant Anthology\index{arahant}: Non-Trainee Suttas}
...
When truths become manifest\\
to the ardent, meditating seeker ---\\
he stands scattering Māra's army\index{Māra}\\
...
The Netti closes with one last structural insight. All defilement-sharing suttas can be analyzed through four grounds of defilement: the ground of underlying tendency\index{defilements!four grounds|textbf}, the ground of active obsession, the ground of the fetter, and the ground of clinging.\footnote{Pali: \textit{``Saṃkilesabhāgiyaṃ suttaṃ catūhi kilesabhūmīhi niddisitabbaṃ --- anusayabhūmiyā pariyuṭṭhānabhūmiyā saṃyojanabhūmiyā upādānabhūmiyā.''} The four grounds of defilement (\textit{kilesabhūmi}): (1) underlying tendency (\textit{anusaya}) --- the dormant seed; (2) active obsession (\textit{pariyuṭṭhāna}) --- the seed sprouting; (3) fetter (\textit{saṃyojana}) --- the obsession binding; (4) clinging (\textit{upādāna}) --- the binding becoming fuel for existence.}
