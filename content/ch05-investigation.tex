\chapter{The Investigation Mode}\index{modes!Investigation Mode|textbf}
...
\begin{versebox}
``By ignorance\index{ignorance|textbf} the world is wrapped, Ajita,''\\
...
without remainder ---\\
with the cessation of consciousness\index{cessation}\index{nibbāna},\\
