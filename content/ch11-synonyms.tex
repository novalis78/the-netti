...
The Synonym Mode is the tool for recognizing when different words mean the same thing. Without it, you might read a sutta that mentions ``hope,'' ``longing,'' ``delight,'' and ``the current'' and think the Buddha was talking about four different mental states. He was talking about one: craving.
