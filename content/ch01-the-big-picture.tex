\chapter{The Big Picture}\index{Saṅgahavāro|see{Big Picture, chapter}}
\index{hāras|see{modes (sixteen)}}
\index{nayas|see{methods (five)}}
\index{mūlapadā|see{root terms (eighteen)}}
\index{samatha|see{calm}}
\index{vipassanā|see{insight}}
\index{saṃsāra|see{cycle of existence}}
\index{khandha|see{aggregates (five)}}
\index{paṭiccasamuppāda|see{dependent origination}}
\index{sīla|see{virtue}}
\index{samādhi|see{concentration}}
\index{paññā|see{wisdom}}
\index{dukkha|see{suffering}}
\index{taṇhā|see{craving}}
\index{avijjā|see{ignorance}}
\index{magga|see{Noble Eightfold Path}}
\index{nirodha|see{cessation}}
\index{anattā|see{not-self}}
\index{anicca|see{impermanence}}
\index{sakkāyadiṭṭhi|see{identity-view}}
\index{bodhipakkhiyā dhammā|see{awakening factors (thirty-seven)}}
\label{ch:big-picture}

\begin{versebox}
The world reveres him; even its guardians bow.\\
So learn his teaching well --- it's worth knowing how.
\stanza
Each sutta has two layers: letter and intent.\\
You need them both: the words, and what they meant.
\stanza
Sixteen modes, five methods, eighteen roots ---\\
Mahākaccāyana laid down these tools\index{Mahākaccāyana|textbf}.
\stanza
The modes read the phrasing; methods find the point.\\
Grasp both, and read each sutta joint by joint.
\stanza
The teaching and what's taught --- both must combine.\\
Here are nine approaches. Now: begin.
\end{versebox}

\noindent That's the whole book in five verses. Let's slow down and see what just happened.\footnote{The original opening is five verses in Pali (\textit{Saṅgahavāro}, ``The Summary Section''), lines 1--5 of the Nettippakaraṇa. The Pali reads: \textit{``Yaṃ loko pūjayate, salokapālo sadā namassati ca; / Tasseta sāsanavaraṃ, vidūhi ñeyyaṃ naravarassa.''} --- ``He whom the world worships, whom even the world-guardian always pays homage to; his excellent teaching should be known by the wise, the teaching of the best of men.'' Our verse translation condenses the spirit rather than tracking word-by-word.}
